...
btc_5 = period.Period(period_size=(60 * 30), product='BTC-USD', name='BTC30')
eth_5 = period.Period(period_size=(60 * 30), product='ETH-USD', name='ETH30')
ltc_5 = period.Period(period_size=(60 * 30), product='LTC-USD', name='LTC30')
eth_btc5 = period.Period(period_size=(60 * 30), product='ETH-BTC', name='ETHBTC30')
eth_btc15 = period.Period(period_size=(60 * 15), product='ETH-BTC', name='ETHBTC15')
ltc_btc5 = period.Period(period_size=(60 * 30), product='LTC-BTC', name='LTCBTC30')
ltc_btc15 = period.Period(period_size=(60 * 15), product='LTC-BTC', name='LTCBTC15')
